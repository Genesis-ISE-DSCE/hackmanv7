      ...
      <div className="text-center">
        ...
        >
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body accordian-ans">
               <p>Hackman v7 has an open theme for the choice of topics, meaning participants are free to work on any project belonging to a domain of their liking.</p>
              </div>
            </div>
          </div>
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body accordian-ans">
                <p>
                Yes. Food, shelter and timely refreshments will be provided to all the participants throughout the duration of the Hackathon.
                </p>
              </div>
            </div>
          </div>
